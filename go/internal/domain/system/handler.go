...
func (h *Handler) HealthCheck(_ context.Context) (*oas.HealthCheckOK, error) {
	return &oas.HealthCheckOK{Status: oas.HealthCheckOKStatusOk}, nil
}

func (h *Handler) GetInfo(_ context.Context) (*oas.GetInfoOK, error) {
...
func (h *Handler) ClearStatistics(ctx context.Context) error {
	if err := h.stats.ClearAll(ctx); err != nil {
		return fmt.Errorf("clearing statistics: %w", err)
	}
	return nil
}
