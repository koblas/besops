...
func (c *ComposedHandler) NewError(ctx context.Context, err error) *oas.DefaultErrorStatusCode {
...
func (c *ComposedHandler) Login(ctx context.Context, req *oas.LoginRequest) (*oas.LoginResponse, error) {
...
func (c *ComposedHandler) RefreshToken(ctx context.Context, req *oas.RefreshTokenRequest) (*oas.TokenResponse, error) {
	return c.users.RefreshToken(ctx, req)
}

func (c *ComposedHandler) ChangePassword(ctx context.Context, req *oas.ChangePasswordReq) (*oas.TokenResponse, error) {
...
func (c *ComposedHandler) GetMonitorUptimes(ctx context.Context) ([]oas.GetMonitorUptimesOKItem, error) {
...
func (c *ComposedHandler) GetMonitor(ctx context.Context, params oas.GetMonitorParams) (*oas.Monitor, error) {
...
func (c *ComposedHandler) UpdateMonitor(ctx context.Context, req *oas.MonitorInput, params oas.UpdateMonitorParams) (*oas.Monitor, error) {
	return c.monitors.UpdateMonitor(ctx, req, params)
}

func (c *ComposedHandler) DeleteMonitor(ctx context.Context, params oas.DeleteMonitorParams) error {
...
func (c *ComposedHandler) GetStatusPage(ctx context.Context, params oas.GetStatusPageParams) (*oas.StatusPage, error) {
