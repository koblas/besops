...
type preloadCounts struct {
	Group        groupCountPreloader
	Maintenance  maintenanceCountPreloader
	Monitor      monitorCountPreloader
	Notification notificationCountPreloader
	StatusPage   statusPageCountPreloader
	Tag          tagCountPreloader
	User         userCountPreloader
}

func getPreloadCount() preloadCounts {
	return preloadCounts{
		Group:        buildGroupCountPreloader(),
		Maintenance:  buildMaintenanceCountPreloader(),
		Monitor:      buildMonitorCountPreloader(),
		Notification: buildNotificationCountPreloader(),
		StatusPage:   buildStatusPageCountPreloader(),
		Tag:          buildTagCountPreloader(),
		User:         buildUserCountPreloader(),
	}
}

type thenLoadCounts[Q orm.Loadable] struct {
	Group        groupCountThenLoader[Q]
	Maintenance  maintenanceCountThenLoader[Q]
	Monitor      monitorCountThenLoader[Q]
	Notification notificationCountThenLoader[Q]
	StatusPage   statusPageCountThenLoader[Q]
	Tag          tagCountThenLoader[Q]
	User         userCountThenLoader[Q]
}

func getThenLoadCount[Q orm.Loadable]() thenLoadCounts[Q] {
	return thenLoadCounts[Q]{
		Group:        buildGroupCountThenLoader[Q](),
		Maintenance:  buildMaintenanceCountThenLoader[Q](),
		Monitor:      buildMonitorCountThenLoader[Q](),
		Notification: buildNotificationCountThenLoader[Q](),
		StatusPage:   buildStatusPageCountThenLoader[Q](),
		Tag:          buildTagCountThenLoader[Q](),
