...
func (h *Handler) HealthCheck(ctx context.Context) (*oas.HealthCheckOK, error) {
	return &oas.HealthCheckOK{Status: oas.HealthCheckOKStatusOk}, nil
}

func (h *Handler) GetInfo(ctx context.Context) (*oas.GetInfoOK, error) {
	...
	return &oas.GetInfoOK{
		...
		PrimaryBaseURL:       oas.OptString{},
		ServerTimezone:       oas.NewOptString(tz),
		ServerTimezoneOffset: oas.NewOptString(tzOffset.String()),
	}, nil
}

func (h *Handler) GetDatabaseSize(ctx context.Context) (*oas.GetDatabaseSizeOK, error) {
	var size int64
...
func (h *Handler) ShrinkDatabase(ctx context.Context) (*oas.MessageResponse, error) {
...
func (h *Handler) ClearStatistics(ctx context.Context) error {
	return h.stats.ClearAll(ctx)
}
