...
func (s *DockerHost) Validate() error {
	...
	if err := func() error {
		if err := s.DockerType.Validate(); err != nil {
			return err
		}
		return nil
	}(); err != nil {
	...
	if err := func() error {
		if value, ok := s.DockerDaemon.Get(); ok {
			if err := func() error {
				if err := (validate.String{
					MinLength:     0,
					MinLengthSet:  false,
...
func (s DockerHostDockerType) Validate() error {
	switch s {
	case "socket":
		return nil
	case "tcp":
...
func (s *DockerHostInput) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s DockerHostInputDockerType) Validate() error {
	switch s {
	case "socket":
		return nil
	case "tcp":
...
func (s *Monitor) Validate() error {
	...
	if err := func() error {
		if value, ok := s.DockerContainer.Get(); ok {
			if err := func() error {
				if err := (validate.String{
					MinLength:     0,
					MinLengthSet:  false,
...
func (s MonitorDnsResolveType) Validate() error {
	switch s {
	case "A":
		return nil
	case "AAAA":
...
func (s MonitorMethod) Validate() error {
	switch s {
	case "GET":
		return nil
	case "POST":
